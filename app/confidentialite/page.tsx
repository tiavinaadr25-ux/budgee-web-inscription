    ...
    >
      ...
      >
        ...
        <p style={{ margin: '0 0 12px', color: '#485366', lineHeight: 1.6 }}>
          Cette page est une version provisoire de la politique de confidentialité
          de Budgee. Elle sera remplacée par la version juridique finale avant
          lancement public.
        </p>
        <p style={{ margin: '0 0 12px', color: '#485366', lineHeight: 1.6 }}>
          Pour toute question sur tes données, tu peux nous écrire à{' '}
          <a
